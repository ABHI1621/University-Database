...
public class TeachesPK implements Serializable {
    ...
    public TeachesPK(String id, String courseId, String secId, String semester, short year) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TeachesPK)) {
            return false;
        }
        TeachesPK other = (TeachesPK) object;
    ...
    public String toString() {
        return "universitydb.TeachesPK[ id=" + id + ", courseId=" + courseId + ", secId=" + secId + ", semester=" + semester + ", year=" + year + " ]";
    }
