...
public class InstructorForm extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT i FROM Instructor i");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                InstructorForm.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                InstructorForm.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                InstructorForm.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                InstructorForm.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == BackButton) {
                InstructorForm.this.BackButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<universitydb.Instructor> toRemove = new ArrayList<universitydb.Instructor>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            universitydb.Instructor i = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(i);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        universitydb.Instructor i = new universitydb.Instructor();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<universitydb.Instructor> merged = new ArrayList<universitydb.Instructor>(list.size());
            for (universitydb.Instructor i : list) {
    ...
    private java.util.List<universitydb.Instructor> list;
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new InstructorForm());
